...
class DmozSpider(Spider):
    ...
    start_urls = [
        "http://www.chakri.com/job?circular_type=newspaper&page=1",
        "http://www.chakri.com/job?circular_type=newspaper&page=2",
        "http://www.chakri.com/job?circular_type=newspaper&page=3",
        "http://www.chakri.com/job?circular_type=newspaper&page=4",
