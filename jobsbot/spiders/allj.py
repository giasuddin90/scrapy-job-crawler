...
class DmozSpider(Spider):
    ...
    start_urls = [
        ...
        "http://www.chakri.com/job?circular_type=govtjob&page=4",
        "http://www.chakri.com/job?circular_type=govtjob&page=5",
        "http://www.chakri.com/job?circular_type=govtjob&page=6",
        "http://www.chakri.com/job?circular_type=govtjob&page=7",
        "http://www.chakri.com/job?circular_type=govtjob&page=8",
        "http://www.chakri.com/job?circular_type=govtjob&page=9",
        "http://www.chakri.com/job?circular_type=govtjob&page=10",
        "http://www.chakri.com/job?circular_type=govtjob&page=11",
        "http://www.chakri.com/job?circular_type=govtjob&page=12",
        "http://www.chakri.com/job?circular_type=govtjob&page=13",
        "http://www.chakri.com/job?circular_type=govtjob&page=14",
    ]
